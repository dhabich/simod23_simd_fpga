...
namespace tvl {
   ...
   namespace functors {
      ...
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<uint32_t, avx512>, N, Idof> {
            using Vec = simd<uint32_t, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_i32gather_epi32(index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<uint64_t, avx512>, N, Idof> {
            using Vec = simd<uint64_t, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_i64gather_epi64(index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<int32_t, avx512>, N, Idof> {
            using Vec = simd<int32_t, avx512>;
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<int64_t, avx512>, N, Idof> {
            using Vec = simd<int64_t, avx512>;
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<float, avx512>, N, Idof> {
            using Vec = simd<float, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_i32gather_ps(index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct gather<simd<double, avx512>, N, Idof> {
            using Vec = simd<double, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_i64gather_pd(index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<uint32_t, avx512>, N, Idof> {
            using Vec = simd<uint32_t, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_mask_i32gather_epi32(source, mask, index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<uint64_t, avx512>, N, Idof> {
            using Vec = simd<uint64_t, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_mask_i64gather_epi64(source, mask, index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<int32_t, avx512>, N, Idof> {
            using Vec = simd<int32_t, avx512>;
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<int64_t, avx512>, N, Idof> {
            using Vec = simd<int64_t, avx512>;
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<float, avx512>, N, Idof> {
            using Vec = simd<float, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_mask_i32gather_ps(source, mask, index, memory, scale());
            }
         };
   ...
   namespace functors {
       ...
       */
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_gather<simd<double, avx512>, N, Idof> {
            using Vec = simd<double, avx512>;
            ...
            static typename Vec::register_type apply(
               ...
               return _mm512_mask_i64gather_pd(source, mask, index, memory, scale());
            }
         };
      ...
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct scatter<simd<float, avx512>, N, Idof> {
            ...
            static void apply(
               ...
               _mm512_i32scatter_ps(memory, index, data, scale());
            }
         };
      ...
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct scatter<simd<double, avx512>, N, Idof> {
            ...
            static void apply(
               ...
               _mm512_i64scatter_pd(memory, index, data, scale());
            }
         };
      ...
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_scatter<simd<float, avx512>, N, Idof> {
            ...
            static void apply(
               ...
               _mm512_mask_i32scatter_ps(memory, mask, index, data, scale());
            }
         };
      ...
      template<int N, ImplementationDegreeOfFreedom Idof>
         struct mask_scatter<simd<double, avx512>, N, Idof> {
            ...
            static void apply(
               ...
               _mm512_mask_i64scatter_pd(memory, mask, index, data, scale());
            }
         };
